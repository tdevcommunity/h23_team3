...
const FormSchema = z.object({
    ...
    username:z.string().min(2,{
        message:"Votre nom d'utilisateur est requis "
    })
})
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex gap-4 flex-col ">
                                            ...
                                            <FormControl>
                                                <Input className="h-12 px-4  " type="text" placeholder="Entrer votre nom d'utilisateur" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex gap-4 flex-col ">
                                            ...
                                            <FormControl>
                                                <Input className="h-12 px-4  " type="email" placeholder="Entrer votre email" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField control={form.control} name="password"
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input className="h-12 px-4 ring-offset-xmentor/50 focus-visible:ring-xmentor/10" type="password" placeholder="Entrer votre mot de passe" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )} />
                                <div className="pt-5 ">
                                    <Button className="w-full bg-mentor hover:bg-xmentor/90 " type="submit">Inscription</Button>
                                </div>
                            </form>
                        </Form>
                    </div>
