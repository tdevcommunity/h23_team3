                                        ...
                                        <div key="index" className='flex group bg-white hover:bg-blue-50 rounded-md duration-300 hover:cursor-pointer hover:border-xmentor hover:hover-2  border mb-6 px-5  py-6  '>
                                            <div className='w-5/6 '>
                                                ...
                                                <div className='flex gap-3 pt-4 '>
                                                    <span className='px-2 text-sm   py-1 bg-gray-200 '>HTML</span>
                                                    <span className='px-2 text-sm   py-1 bg-gray-200 '>React js</span>
                                                    <span className='px-2 text-sm   py-1 bg-gray-200 '>Java</span>
